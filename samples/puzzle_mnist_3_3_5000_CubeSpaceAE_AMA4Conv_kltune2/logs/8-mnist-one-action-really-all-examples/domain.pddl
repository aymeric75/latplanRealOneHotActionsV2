(define (domain latent)
 ...
 (:predicates (z0) (z1) (z2) (z3) (z4) (z5) (z6) (z7) (z8) (z9) (z10)
  ...
  (z297) (z298) (z299))
 (:action a0+205 :parameters () :precondition
  (and (not (z9)) (not (z14)) (z29) (not (z38)) (not (z74))
       (not (z113)) (not (z114)) (not (z128)) (not (z130))
       (not (z134)) (not (z162)) (not (z163)) (not (z164))
       (not (z166)) (not (z173)) (not (z175)) (not (z185))
       (not (z189)) (not (z190)) (z192) (not (z194)) (not (z205))
       (z209) (not (z211)) (not (z215)) (not (z244)) (not (z260))
       (not (z263)) (not (z264)) (not (z276)) (not (z289)))
  :effect
  (and (not (z9)) (not (z14)) (not (z29)) (not (z38)) (not (z74))
       (not (z113)) (not (z114)) (not (z128)) (not (z130))
       (not (z134)) (not (z162)) (not (z163)) (not (z164))
       (not (z166)) (not (z173)) (not (z175)) (not (z185))
       (not (z189)) (not (z190)) (not (z192)) (not (z194)) (z205)
       (not (z209)) (not (z211)) (not (z215)) (not (z244))
       (not (z260)) (not (z263)) (not (z264)) (not (z276))
       (not (z289))))
 (:action a0-205 :parameters () :precondition
  (and (not (z9)) (not (z14)) (z29) (not (z38)) (not (z74))
       (not (z113)) (not (z114)) (not (z128)) (not (z130))
       (not (z134)) (not (z162)) (not (z163)) (not (z164))
       (not (z166)) (not (z173)) (not (z175)) (not (z185))
       (not (z189)) (not (z190)) (z192) (not (z194)) (z205) (z209)
       (not (z211)) (not (z215)) (not (z244)) (not (z260))
       (not (z263)) (not (z264)) (not (z276)) (not (z289)))
  :effect
  (and (not (z9)) (not (z14)) (not (z29)) (not (z38)) (not (z74))
       (not (z113)) (not (z114)) (not (z128)) (not (z130))
       ...
       (not (z205)) (not (z209)) (not (z211)) (not (z215))
       (not (z244)) (not (z260)) (not (z263)) (not (z264))
       (not (z276)) (not (z289)))))
